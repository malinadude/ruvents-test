...
export default {
  ...
  methods: {
    ...
    async generateBase() {
      ...
      // 10kk записей | 10.000.000 (тз записи) ÷ 10.000 (10к записей из теста) × 7 (секунды нашего теста) ÷ 60 (секунд в минуте) = 116,6666666666667 (минут примерно займет генерация 10кк записей)
    },
    async clearBase() {
      await this.$store.dispatch("baseStrokesLoading/putLoading", true);
